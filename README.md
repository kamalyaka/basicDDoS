...
---
### This repository includes 2 python scripts you can experiment with! You can tweak around the values to get it working on LAN or over the internet as the script runs on localhost by default.
### 🔓 The code is free to use, you can do whatever you want with the source code.
#### originally written by kamalyaka, kamalyaka Projects
